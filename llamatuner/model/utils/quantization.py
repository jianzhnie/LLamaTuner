...
from transformers import (BitsAndBytesConfig, GPTQConfig, PretrainedConfig,
                          PreTrainedTokenizer)
...
from llamatuner.utils.misc import get_current_device
...
def _get_quantization_dataset(tokenizer: 'PreTrainedTokenizer',
                              model_args: 'ModelArguments') -> List[str]:
    r"""
    ...
    for _ in range(model_args.export_quantization_nsamples):
        while True:
            ...
            sample: Dict[str,
                         torch.Tensor] = tokenizer(dataset[sample_idx]['text'],
                                                   return_tensors='pt')
...
def configure_quantization(
    ...
    if getattr(config, 'quantization_config', None):  # ptq
        ...
        quantization_config: Dict[str,
                                  Any] = getattr(config, 'quantization_config',
                                                 None)
        ...
        if quant_method == QuantizationMethod.GPTQ:
            ...
            quantization_config.pop('disable_exllama',
                                    None)  # remove deprecated args
        ...
        if model_args.quantization_bit == 8:
            ...
            init_kwargs['quantization_config'] = BitsAndBytesConfig(
                ...
                bnb_4bit_quant_storage=model_args.
                compute_dtype,  # crucial for fsdp+qlora
            )
